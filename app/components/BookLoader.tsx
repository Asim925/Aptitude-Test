...
/**
 * Tailwind + React — Animated Book Loader (amber theme)
 * Based on Uiverse.io by anand_4957, adapted for Tailwind.
 */
    ...
    <div className="flex flex-col items-center gap-2">
      <div className={`book ${className}`}>
        ...
        .book {
          ...
          box-shadow:
            0 0.25em 0.5em #d97706,
            0 0 0 0.25em #d97706 inset;
          padding: 0.25em;
          perspective: 37.5em;
          position: relative;
          width: 8em;
        ...
        .book__pg--4 {
          background-image: repeating-linear-gradient(
              hsl(45, 10%, 20%) 0 0.125em,
              hsla(45, 10%, 20%, 0) 0.125em 0.5em
            ),
            linear-gradient(90deg, hsla(45, 10%, 90%, 0) 87.5%, hsl(45, 10%, 90%));
